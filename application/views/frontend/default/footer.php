        ...
        <?php
            ...
            $paystack_info = json_decode(get_settings('paystack_keys'), true);
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <form action="<?php echo site_url('home/paystack_checkout'); ?>" method="post">
                                    <input type="hidden" class = "total_price_of_checking_out" name="total_price_of_checking_out" value="">
                                    <button type="submit" class="btn btn-primary paystack" <?php echo $paystack_status; ?>><?php echo get_phrase('paystack'); ?></button>
                                </form>
                            </div>

    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                ...
                <!-- Modal -->
                <div class="modal fade" id="samplepreviewmodel" tabindex="-1"  data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="previewvideotitle">.....</h6>
                                <button type="button" class="close" onclick="reloadpage()"  aria-label="Close">

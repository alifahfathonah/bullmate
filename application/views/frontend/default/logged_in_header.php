            ...
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <a href="<?php echo site_url(''); ?>" class="navbar-brand" href="#">
                        <img src="<?php echo base_url().'uploads/system/logo-dark.png'; ?>" style="cursor: pointer;" alt="" height="35">
                    </a>
                    ...
                    <form class="inline-form" action="<?php echo site_url('home/search'); ?>" method="get" style="width: 100%;">
                        <div class="input-group search-box mobile-search" style="width: 100%;margin-right: 10px">
                    ...
                    <?php if (get_settings('allow_instructor') == 1): ?>
                        <div class="instructor-box menu-icon-box">
                                ...
                                <?php elseif( $user_details['type'] == 3 && $user_details['is_request'] == 0): ?>
                                    <div>
                                <a class="btn btn-info btn-sm" href="<?php echo site_url('home/become_an_instructor'); ?>" style="border: 1px solid transparent; font-size: 14px; border-radius: 0;"><?php echo get_phrase('Teach_on_Bullmate'); ?></a>
                                    </div>
                                <?php endif; ?>

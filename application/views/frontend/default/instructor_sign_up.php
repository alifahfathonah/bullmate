                            ...
                            <div class="content-box">
                                <div class="basic-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="checkbox" name="terms" id="terms" checked> I agree to the privacy <a href="<?=base_url().$page?>">policies</a>, <a href="<?= base_url().$terms_page?>">terms and conditions</a> of Bullmate.
                                    </div>
                                </div>
                            </div>

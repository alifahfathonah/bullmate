    ...
    <div class="row">
      <div class="col">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
          ...
          <a href="<?php echo site_url(''); ?>" class="navbar-brand" href="#"><img src="<?php echo base_url().'uploads/system/logo-dark.png'; ?>"  style="cursor: pointer;"  alt="" height="35"></a>
          ...
          <a class="btn btn-info btn-sm" href="<?php echo site_url('home/sign_up?type=2'); ?>" style="border: 1px solid transparent; font-size: 14px; border-radius: 0;"><?php echo get_phrase('Become_an_Instructor'); ?></a>

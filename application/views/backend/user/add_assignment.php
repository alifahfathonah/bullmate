...
<form action="<?php echo site_url('user/lessons/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" data-toggle="select2" name="lesson_type" id="lesson_type" required onchange="show_lesson_type_form(this.value)">
            ...
            <option value="assignment-pdf"><?php echo get_phrase('pdf_file'); ?></option>
            <option value="assignment-doc"><?php echo get_phrase('doc_file'); ?></option>
            <option value="assignment-ppt"><?php echo get_phrase('ppt_file'); ?></option>
            <option value="assignment-xls"><?php echo get_phrase('xls_file'); ?></option>
            <option value="assignment-img"><?php echo get_phrase('image_file'); ?></option>
        </select>
    </div>

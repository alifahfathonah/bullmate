...
<form action="<?php echo site_url('user/lessons/'.$param2.'/add'); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" data-toggle="select2" name="lesson_type" id="lesson_type" required onchange="show_lesson_type_form(this.value)">
            <option value=""><?php echo get_phrase('select_type_of_assignment'); ?></option>
            <option value="assignment-pdf" <?php if($lesson_details['attachment_type'] == 'pdf') echo 'selected'; ?>><?php echo get_phrase('pdf_file'); ?></option>
            <option value="assignment-doc" <?php if($lesson_details['attachment_type'] == 'doc') echo 'selected'; ?>><?php echo get_phrase('doc_file'); ?></option>
            <option value="assignment-ppt" <?php if($lesson_details['attachment_type'] == 'ppt') echo 'selected'; ?>><?php echo get_phrase('ppt_file'); ?></option>
            <option value="assignment-xls" <?php if($lesson_details['attachment_type'] == 'xls') echo 'selected'; ?>><?php echo get_phrase('xls_file'); ?></option>
            <option value="assignment-img" <?php if($lesson_details['attachment_type'] == 'img') echo 'selected'; ?>><?php echo get_phrase('image_file'); ?></option>
        </select>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="text-center">
            <button class = "btn btn-success" type="submit" name="button"><?php echo get_phrase('add_assignment'); ?></button>
        </div>
    </form>

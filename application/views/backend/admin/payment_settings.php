        ...
        <div class="card-body">
            ...
            <div class="form-group">
                    ...
                    <select class="form-control select2" data-toggle="select2" id = "paystack_currency" name="paystack_currency" required>
                        ...
                        <?php
                        $currencies = $this->crud_model->get_paystack_supported_currencies();
                        foreach ($currencies as $currency):?>
                        <option value="<?php echo $currency['code'];?>"
            ...
            <div class="form-group">
                <label><?php echo get_phrase('test_secret_key'); ?></label>
                <input type="text" name="secret_key" class="form-control" value="<?php echo $paystack[0]->secret_key;?>" required />
            </div>

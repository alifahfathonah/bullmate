            ...
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="instructor_terms"><?php echo get_phrase('instructor_terms'); ?></label>
                        <textarea name="instructor_terms" id ="instructor_terms" class="form-control" rows="5"><?php echo get_frontend_settings('instructor_terms'); ?></textarea>
                    </div>
                    <div class="form-group">

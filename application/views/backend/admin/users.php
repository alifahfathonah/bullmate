                ...
                <table id="basic-datatable" class="table table-striped table-centered mb-0">
                  <thead>
                    <tr>
                      ...
                      <th><?php echo get_phrase('Request_For_Instructor'); ?></th>
                  ...
                  <tbody>
                      <?php
                       foreach ($users->result_array() as $key => $user): ?>
                        <?php
                         if(($user['type'] != 2 && $user['is_request'] == 0) || ($user['type'] != 2 && $user['is_request'] == 1)):
                        ?>
                          <tr>
                              ...
                              <td>
                                  <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                      ...
                                      <li>
                                        <?php
                                        if($user['is_request'] == 1 && $user['type'] == 3):
                                        ?>
                                        <a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/user_switching/instructor/'.$user['id']); ?>');"><?php echo get_phrase('accept_as_instructor'); ?></a>

<a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/user_switching/cancel/'.$user['id']); ?>');"><?php echo get_phrase('request_cancel'); ?></a>

                                        <?php
                                          endif;
                                        ?>
                            <?php
                            if($user['is_request'] == 0 && $user['type'] == 3):
                            ?>
                            <a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('admin/user_switching/instructor/'.$user['id']); ?>');"><?php echo get_phrase('make_as_instructor'); ?></a>
                            <?php
                            endif;
                            ?>
                                      </li>
